...
var getClassName = function getClassName(_ref) {
  ...
  return ClassNames(prefixCls, className, _defineProperty({}, "".concat(prefixCls, "-disabled"), disabled));
};
...
var parseValue = function parseValue(_ref2) {
  var type = _ref2.type,
      value = _ref2.value;
  var newValue = value;
  var inputValue = compose(function (v) {
...
var Input = function Input(props) {
  ...
  var inputClass = ClassNames("".concat(prefixCls, "-input"), _defineProperty({}, "".concat(prefixCls, "-group"), !!addonBefore || !!addonAfter));
  useEffect(function () {
